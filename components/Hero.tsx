      ...
      <div className="relative max-w-7xl mx-auto px-6 z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          ...
          <div className="lg:col-span-7">
            <div className="inline-flex items-center space-x-2 px-4 py-2 rounded-full bg-blue-50 text-blue-700 mb-8 border border-blue-100">
            ...
            <h2 className="text-2xl lg:text-3xl font-bold text-blue-600 mb-8 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 no-print">
              <a 
                ...
                className="px-10 py-5 bg-slate-900 text-white font-bold rounded-2xl hover:bg-blue-600 transition-all shadow-2xl flex items-center gap-3"
              >
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-10 py-5 bg-white text-slate-900 font-bold rounded-2xl border-2 border-slate-200 hover:border-blue-600 hover:text-blue-600 transition-all flex items-center gap-3"
              >
            ...
            <div className="mt-16 grid grid-cols-2 sm:grid-cols-4 gap-8 border-t border-slate-100 pt-10">
              <div>
                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Location</p>
                <p className="text-sm font-bold text-slate-900">Georgia, USA</p>
              </div>
              <div>
              ...
              <div className="col-span-2">
                ...
                <p className="text-sm font-bold text-slate-900 underline underline-offset-4 decoration-blue-200 hover:text-blue-600 transition-colors">
          ...
          <div className="lg:col-span-5 flex justify-center lg:justify-end">
            <div className="relative w-full max-w-md aspect-[4/5] bg-slate-900 rounded-[3rem] overflow-hidden border-8 border-white shadow-2xl group">
              {/* Background Initials */}
              <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
                <span className="text-[15rem] font-black text-white/5 select-none">BB</span>
              </div>
              ...
              {!imageError ? (
                <img 
                  ...
                  onError={() => {
                    console.error("Failed to load image from:", contactInfo.profileImage);
                    setImageError(true);
                  }}
                  className="relative w-full h-full object-cover z-10 transition-transform duration-700 group-hover:scale-105"
                />
              ) : (
                <div className="relative w-full h-full flex items-center justify-center z-10 bg-slate-800 text-slate-600 p-12 text-center italic text-sm">
                  Image "brian-burns.jpg" not found in root directory.
                </div>
              )}
